...
main (int argc, char** argv)
{
    ...
    pcl::PointIndices::Ptr inflo_inliers(new pcl::PointIndices);
    pcl::PointIndices::Ptr inflo_outliers(new pcl::PointIndices);
    inflo(cloud, threshold, inflo_inliers, inflo_outliers, sor_K);
...
*/
    ...
    pcl::ExtractIndices<pcl::PointXYZ> eifilter; 
    eifilter.setInputCloud (cloud);
    eifilter.setIndices (inflo_inliers);
    eifilter.setNegative (false);
    eifilter.filter (*_cloud_noiseless);
